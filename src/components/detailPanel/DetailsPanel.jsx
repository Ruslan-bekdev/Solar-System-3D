...
const sunContent = {
	"sections": [
		{
			"title": "Описание",
			"text": "Солнце — звезда в центре нашей Солнечной системы, источник света и тепла для всех планет."
		},
		{
			"title": "Факты",
			"text": [
		...
		{
			"title": "Особенности",
			"text": "Солнце — гигантский шар плазмы, состоящий в основном из водорода и гелия, поддерживающий жизнь на Земле."
		}
	],
	"marquee": [
		"Самый яркий объект нашей системы",
